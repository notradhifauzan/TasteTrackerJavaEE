				...
				<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
					<div class="navbar-nav mx-auto">
						<a href="RecipeController?action=home" class="nav-item nav-link active">Home</a> <a
							href="RecipeController?action=home" class="nav-item nav-link">Community Recipes</a>
			...
			<div class="tab-class text-center">
				<div class="row g-4">
					...
					<a role="button" class="btn btn-outline-primary mb-3"
						href="RecipeController?action=add">add new recipe</a> <br>
				</div>
										...
										<div class="col-md-6 col-lg-4 col-xl-3">
											<div class="rounded position-relative fruite-item">
												...
												<div
													...
													style="top: 10px; left: 10px;"><c:out value="${recipe.status}" /></div>
												<div
													...
													<div class="d-flex justify-content-between flex-lg-wrap">
														...
														<a href="RecipeController?action=details&recipeId=<c:out value='${recipe.recipeID}' />"
															...
															More</a>
														<a href="RecipeController?action=delete&recipeId=<c:out value='${recipe.recipeID}' />"
															class="btn btn-danger border border-danger rounded-pill px-3 text-white">
															Delete</a>
													</div>
												</div>
											</div>
