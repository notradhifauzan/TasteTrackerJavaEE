												...
												<div
													...
													<div class="d-flex justify-content-between flex-lg-wrap">
														...
														<a class="btn btn-outline-warning" role="button"
															href="RecipeController?action=approve&recipeId=${recipe.recipeID}">approve</a>
														<a class="btn btn-danger" role="button"
															href="RecipeController?action=delete&recipeId=${recipe.recipeID}&role=admin">delete</a>
													</div>
												</div>
											</div>
										</div>
