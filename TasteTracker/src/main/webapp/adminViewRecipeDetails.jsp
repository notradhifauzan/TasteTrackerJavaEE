								...
								<div class="tab-pane" id="nav-mission" role="tabpanel"
									...
									<c:forEach items="${comments}" var="comment">
										...
										<a role="button" class="btn btn-outline-danger"
											href="CommentController?action=delete&delete_request_by=admin&commentId=${comment.id_comment}&recipeId=${recipe.recipeID}&inventorId=${recipe.inventorID}">delete</a>
									</c:forEach>
								</div>
							</div>
						</div>
