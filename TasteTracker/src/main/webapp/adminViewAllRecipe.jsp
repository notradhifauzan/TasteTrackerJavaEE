											...
											<div class="rounded position-relative fruite-item">
												...
												<div
													...
													<div class="d-flex justify-content-between flex-lg-wrap">
														...
														<a
															href="RecipeController?action=details&recipeId=${recipe.recipeID}&role=admin"
															class="btn border border-secondary rounded-pill px-3 text-primary">
															More</a> <a class="btn btn-danger" role="button"
															href="RecipeController?action=delete&recipeId=${recipe.recipeID}&role=admin&from=all">delete</a>
													</div>
												</div>
											</div>
										</div>
